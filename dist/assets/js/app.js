...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // LINE BARS
...
var ProgressBar = __webpack_require__(/*! progressbar.js */ "./node_modules/progressbar.js/src/main.js"); //Loop through my divs and create animated circle for each one
...
makeCircles(); // Check if element is scrolled into view
...
function bgCircles(divid, countvalue) {
  ...
  var elem = jQuery('#' + divid); // Design the circle using progressbar.js
  ...
  bar.path.setAttribute('stroke-linecap', 'round'); // Check element visibility and update it, when needed

  checkVisibility(elem, bar, countvalue); // Animate the circle when scrolled into view
...
module.exports = __webpack_require__(/*! /Users/dlipovac/repos/b2l-gated-content-teaser/src/assets/js/app.js */"./src/assets/js/app.js");
